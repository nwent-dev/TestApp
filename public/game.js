...
let muted = false; // Переменная для отслеживания состояния звука
...
function drawBackground() {
    ...
    ctx.drawImage(backgroundImg, backgroundX + bgWidth, 0, bgWidth, canvas.height);
...
function update() {
    ...
    if (airplane.y + airplane.height > canvas.height) airplane.y = canvas.height - airplane.height;
